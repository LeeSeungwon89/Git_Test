...
깃에 숙달해지면 작업 속도를 높이거나 세세하게 제어할 목적으로 CLI를 사용하는 편이 좋습니다.
...
사실 소스트리는 GUI라서 굳이 메모가 필요할까? 사용법이 간단해서 음. 일단 고민해보도록 하겠습니다. 소스트리 설치 방법은 유튜브에 많이 올라와 있습니다. 별도의 계정 가입 절차 없이 깃허브 계정만으로 바로 사용할 수 있습니다.
